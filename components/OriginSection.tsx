  ...
  return (
    ...
    >
      ...
      <div className="absolute top-16 safe-top md:top-16 left-0 right-0 z-50 text-center px-4">
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl text-white animate-fade-in mb-3 text-glow">
          Welcome to Zolar
        </h1>
      ...
      <div className="relative z-10 w-[min(1000px,86vw)] md:w-[min(1200px,80vw)] text-center px-4">
        <div ref={logoRef} className="mx-auto mt-16 sm:mt-12 md:mt-32 mb-6 sm:mb-8 w-[140px] sm:w-[160px] md:w-[260px] will-change-transform">
        ...
        <p className="o-line mt-4 sm:mt-6 md:mt-8 font-body text-white/75 max-w-2xl md:max-w-3xl mx-auto text-base sm:text-lg md:text-xl leading-relaxed px-4">
        ...
        {/* Bottom SVG Icons */}
        <div className="o-line mt-4 sm:mt-6 md:mt-8 mb-8 flex justify-center items-center gap-8 sm:gap-12 md:gap-16">
          {/* SVG Icon 1 */}
          <div className="svg-icon-wrapper">
            <svg className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-white/80 hover:text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 274.72 182.92">
