...
export default function OriginSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-16 safe-top md:top-[10vh] lg:top-[12vh] left-0 right-0 z-50 text-center px-4">
        <h1 className="font-display text-4xl sm:text-5xl md:text-[5rem] lg:text-[6rem] xl:text-[7rem] 2xl:text-[8rem] text-white animate-fade-in mb-3 md:mb-6 lg:mb-8 text-glow md:font-thin md:tracking-wider">
          Welcome to Zolar
        </h1>
        <div className="font-mono text-xs md:text-base lg:text-lg tracking-[0.25em] md:tracking-[0.4em] lg:tracking-[0.5em] text-white/50 animate-fade-in animation-delay-200 mb-4 md:mb-8 lg:mb-10">
          Est. 2025 — From Morocco to the World
        </div>
        <div className="font-mono text-xs md:text-base lg:text-lg tracking-[0.3em] md:tracking-[0.5em] lg:tracking-[0.6em] text-emerald-400/80 md:text-sky-400 animate-fade-in animation-delay-400">
      ...
      <div className="relative z-10 w-[min(1000px,86vw)] md:w-full md:max-w-[1600px] md:mx-auto text-center px-4 md:px-12 lg:px-16">
        <div ref={logoRef} className="mx-auto mt-24 sm:mt-26 md:mt-[20vh] lg:mt-[22vh] mb-6 sm:mb-8 md:mb-16 lg:mb-20 w-[140px] sm:w-[160px] md:w-[320px] lg:w-[380px] xl:w-[420px] will-change-transform md:opacity-90">
          <Image src="/images/zolar-wordmark.svg" alt="Zolar wordmark" width={420} height={150} className="w-full h-auto md:drop-shadow-2xl" />
        </div>
        <h2 className="o-line mt-4 md:mt-12 lg:mt-16 font-display text-4xl sm:text-5xl md:text-[4rem] lg:text-[5rem] xl:text-[6rem] text-white text-shimmer md:font-extralight md:tracking-[0.1em]">
          Made for Motion
        </h2>
        <p className="o-line mt-4 sm:mt-6 md:mt-12 lg:mt-16 font-body text-white/75 max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl leading-relaxed md:leading-loose px-4 md:font-light">
        ...
        {/* Bottom SVG Icons */}
        <div className="o-line mt-4 sm:mt-6 md:mt-20 lg:mt-24 mb-8 md:mb-20 lg:mb-24 flex flex-col md:flex-row justify-center items-center gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24">
          {/* Desktop: Horizontal layout with hover effects */}
          <div className="svg-icon-wrapper md:transform md:hover:scale-110 md:transition-all md:duration-500">
            <svg className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 text-white/80 hover:text-white transition-colors duration-300 md:opacity-70 md:hover:opacity-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 274.72 182.92">
