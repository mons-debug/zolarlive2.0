  ...
  return (
    ...
    >
      ...
      <div className="absolute top-16 safe-top md:top-20 lg:top-24 left-0 right-0 z-50 text-center px-4">
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white animate-fade-in mb-3 md:mb-4 lg:mb-6 text-glow">
          Welcome to Zolar
        </h1>
        <div className="font-mono text-xs md:text-sm lg:text-base tracking-[0.25em] md:tracking-[0.3em] text-white/50 animate-fade-in animation-delay-200 mb-4 md:mb-6">
          Est. 2025 — From Morocco to the World
        </div>
        <div className="font-mono text-xs md:text-sm lg:text-base tracking-[0.3em] md:tracking-[0.35em] text-emerald-400/80 md:text-sky-400 animate-fade-in animation-delay-400">
      ...
      <div className="relative z-10 w-[min(1000px,86vw)] md:w-[min(1400px,85vw)] text-center px-4">
        <div ref={logoRef} className="mx-auto mt-24 sm:mt-26 md:mt-40 lg:mt-48 mb-6 sm:mb-8 md:mb-12 w-[140px] sm:w-[160px] md:w-[280px] lg:w-[320px] will-change-transform">
          <Image src="/images/zolar-wordmark.svg" alt="Zolar wordmark" width={320} height={120} className="w-full h-auto" />
        </div>
        <h2 className="o-line mt-4 md:mt-8 lg:mt-10 font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white text-shimmer">
          Made for Motion
        </h2>
        <p className="o-line mt-4 sm:mt-6 md:mt-10 lg:mt-12 font-body text-white/75 max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed px-4">
        ...
        {/* Bottom SVG Icons */}
        <div className="o-line mt-4 sm:mt-6 md:mt-12 lg:mt-16 mb-8 md:mb-12 lg:mb-16 flex justify-center items-center gap-8 sm:gap-12 md:gap-20 lg:gap-24">
          {/* SVG Icon 1 */}
          <div className="svg-icon-wrapper">
            <svg className="w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 text-white/80 hover:text-white transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 274.72 182.92">
