                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4 md:hidden">
                      <div className="flex items-center justify-center gap-3 mb-2">
                        <span className="text-white/70 text-sm font-medium">Quantity:</span>
                      </div>
                      <div className="flex items-center justify-center gap-3">
                        <button
                          ...
                          onClick={() => setQtyBlack((q) => Math.max(1, q - 1))}
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                          </svg>
                        </button>
                        <span className="min-w-12 text-center text-white font-semibold text-lg">{qtyBlack}</span>
                        <button
                          type="button"
                          aria-label="increase quantity"
                          className="w-10 h-10 rounded-full bg-emerald-400 text-black hover:bg-emerald-500 transition-colors flex items-center justify-center"
                          onClick={() => setQtyBlack((q) => q + 1)}
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-4 md:hidden">
                      ...
                      <div className="flex items-center justify-center gap-3">
                        <button
                          ...
                          aria-label="decrease quantity"
                          className="w-10 h-10 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors flex items-center justify-center"
                          onClick={() => setQtyWhite((q) => Math.max(1, q - 1))}
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                          </svg>
                        </button>
                        <span className="min-w-12 text-center text-white font-semibold text-lg">{qtyWhite}</span>
                        <button
                          type="button"
                          aria-label="increase quantity"
                          className="w-10 h-10 rounded-full bg-sky-400 text-black hover:bg-sky-500 transition-colors flex items-center justify-center"
                          onClick={() => setQtyWhite((q) => q + 1)}
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                          </svg>
